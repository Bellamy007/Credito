...
<div class="widget-header">
    ...
    <div class="widget-content">
        ...
        {!!Form::model(['route'=>['credito.update',$clientes['id']],'method'=>'PUT'])!!}
        <input type="hidden" name="_token" id="_token" value="{{ csrf_token() }}">
            <div class="row">
                <div class="col-sm-4">
                        <div class="form-group">
                            <label for="contact-aval" class="control-label">Folio Credito:</label>
                            <strong> 000{{$clientes['folio']}} </strong>
                            <input type="hidden" name="folio" id="folio" value="{{ $clientes['folio'] }}">
                        </div>
                </div>
                <div class="col-sm-8">
                        <div class="form-group">
                ...
                <div class="col-sm-4">
                        <div class="form-group">
                            <label for="contact-name" class="control-label">Cliente</label>
                                <select class="select2" id="cliente" name='cliente' onchange="infoCLiente('{{route('info.cliente')}}');" required="required">
