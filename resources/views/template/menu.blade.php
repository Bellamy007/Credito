...
<nav class="main-nav">
        <ul class="main-menu">
            <li <?php if(isset($active2)): echo "class='".$active2[0]."'"; endif; ?>><a href="#" class="js-sub-menu-toggle"><i class="fa fa-briefcase"></i><span class="text">Créditos</span>
                <i class="toggle-icon fa fa-angle-left"></i></a>
                    <ul class="sub-menu <?php if(isset($active2)): echo $active2[1]; endif; ?>">
                        <li <?php if(isset($active2)):  if($active2[2]=='busqueda'): echo "class='".$active2[0]."'"; endif; endif; ?>>
                            <a href="{{route('credito.index')}}"><span class="text">B&uacute;squedas</span></a></li>
                        <li <?php if(isset($active2)):  if($active2[2]=='create'): echo "class='".$active2[0]."'"; endif; endif; ?>>
                            <a href="{{route('credito.create')}}"><span class="text">Nuevo Cr&eacute;dito</span></a></li>
                    </ul>
            </li>
